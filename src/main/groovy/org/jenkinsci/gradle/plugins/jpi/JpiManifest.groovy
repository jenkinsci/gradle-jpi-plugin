...
/**
 * This class is no longer used. The manifest is now generated by
 * its own task that declares inputs and outputs to take advantage
 * of Gradle's incremental build.
 *
 * Encapsulates the Jenkins plugin manifest and its generation.
 *
 * @see org.jenkinsci.gradle.plugins.jpi.manifest.GenerateManifestTask
