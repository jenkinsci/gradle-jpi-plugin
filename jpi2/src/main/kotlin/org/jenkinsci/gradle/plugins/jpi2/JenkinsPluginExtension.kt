...
abstract class JenkinsPluginExtension
    @Inject
    constructor(
         ...
         */
        val jenkinsVersion: Property<String> =
            project.objects
                .property(String::class.java)
                .convention(
                    project.providers
                        .gradleProperty(JENKINS_VERSION_PROPERTY)
        ...
        val testHarnessVersion: Property<String> =
            project.objects
                ...
                .convention(
                    project.providers
                        .gradleProperty(TEST_HARNESS_VERSION_PROPERTY)
         ...
         */
        val localizerVersion: Property<String> =
            project.objects
                .property(String::class.java)
                .convention(
                    project.providers
                        .gradleProperty(LOCALIZER_VERSION_PROPERTY)
         ...
         */
        val versionSource: Property<VersionSource> =
            project.objects
                .property(VersionSource::class.java)
         ...
         */
        val pluginFirstClassLoader: Property<Boolean> =
            project.objects
