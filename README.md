...
Set `jpi2.workDir` as a system property when you need a one-off override.
The system property takes precedence over the extension.
...
```shell
./gradlew hplRun -Djpi2.workDir=/tmp/jenkins-dev
```
